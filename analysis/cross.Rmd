...
dat2 <- list(
    ...
    rm_solo_open_rm1civ = list(
        dat = dat$rm_solo_open_rm1civ$wr_naive,
        lab = "RM-Solo-Open-NoSingleCiv Win Rate (%)"
    ),
    rm_solo_closed_rm1civ = list(
        dat = dat$rm_solo_closed_rm1civ$wr_naive,
        lab = "RM-Solo-Closed-NoSingleCiv Win Rate (%)"
    )
)
...
### Solo Open vs Solo Open No-Single-Civ
```{r, rm_solo_open_rm_solo_open_rm1civ}
cross_wr_naive(
    wr1 = dat2$rm_solo_open,
    wr2 = dat2$rm_solo_open_rm1civ
)
```

### Solo Closed vs Solo Closed No-Single-Civ
```{r, rm_solo_closed_rm_solo_closed_rm1civ}
cross_wr_naive(
    wr1 = dat2$rm_solo_closed,
    wr2 = dat2$rm_solo_closed_rm1civ
)
```
