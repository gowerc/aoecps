...
meta_solo <- readRDS("./data/iae12_meta.Rds")
meta_team <- readRDS("./data/tae12_meta.Rds")
...
<img src="../outputs/g_iae12_desc_ELODIST.png" width="70%" style="display: block; margin: auto;" />
<br/> <br/>

### Play Rate by Civilisation

<img src="../outputs/g_iae12_desc_PR.png" width="70%" style="display: block; margin: auto;" />
<br/> <br/>

### Number of Matches per Patch

<img src="../outputs/g_iae12_desc_VERDIST.png" width="70%" style="display: block; margin: auto;" />
...
### Bradley-Terry Performance Scores By Civilisation 

<img src="../outputs/g_iae12_bt_civ.png" width="70%" style="display: block; margin: auto;" />
...
### Bradley-Terry Performance Scores By Civilisation Classifications

<img src="../outputs/g_iae12_bt_cc.png" width="70%" style="display: block; margin: auto;" />
<br/> <br/>

Finally, we can use this same logic to explore the impact of the availability of specific units. 

### Bradley-Terry Performance Scores By Unit

<img src="../outputs/g_iae12_bt_cu.png" width="70%" style="display: block; margin: auto;" />
...
<img src="../outputs/g_tae12_bt_civ.png" width="70%" style="display: block; margin: auto;" />


### Bradley-Terry Performance Scores for Solo vs Team Games

<img src="../outputs/g_ae12_bt_civ.png" width="70%" style="display: block; margin: auto;" />


## Secondary Results

### Difference in Civilisation Win Rate from the Mean by ELO 

```{r, echo = FALSE, results = "asis"}
cl <- readRDS("./outputs/g_ia_slice.Rds")
id <- "cvcwr"
...
### Naive Win Rate By Civilisation

<img src="../outputs/g_iae12_desc_WR.png" width="70%" style="display: block; margin: auto;" />

### Civilisation Play rate vs Naive Win Rate

<img src="../outputs/g_iae12_desc_WRPR.png" width="70%" style="display: block; margin: auto;" />
...
<img src="../outputs/g_iae12_cvc_clust.png" width="70%" style="display: block; margin: auto;" />
<br/><br/>

### Individual Civilisation Plots {.tabset .tabset-fade .tabset-pills}


```{r, echo = FALSE, results = "asis"}
cl <- readRDS("./outputs/g_iae12_cvc_civs.Rds")
id <- "cvcip"
cat(glue::glue('<label for="{id}">Select a Civilisation: </label>'))
cat(glue::glue('<input id="{id}">'))
for ( civ in names(cl)){
...
### Optimal Civilisation Selection

```{r, echo = FALSE, results = "asis"}
odat <- readRDS("./outputs/t_iae12_cvc_opt.Rds") %>%
    filter(p != 0) %>%
